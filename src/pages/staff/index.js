    ...
    return Data[0][category]
      ...
      .map((item, index) => (
        <Link
          ...
          key={index}
          className="min-w-[250px] w-full sm:w-[22%] text-center flex flex-col h-[420px] rounded-2xl bg-white border border-gray-100 hover:border-blue-200 hover:shadow-lg transition-all duration-300 overflow-hidden"
        >
          <div className="relative">
            ...
            />
            <div className="absolute top-3 right-3 w-3 h-3 bg-[#079ADF] rounded-full"></div>
          </div>
          <div className="flex flex-col gap-3 pt-4 px-4 pb-4">
            ...
            <div className="w-12 h-1 bg-[#079ADF] mx-auto rounded-full"></div>
          </div>
        </Link>
      ));
  };
    ...
    <>
      ...
      <section className="relative bg-gradient-to-b from-blue-50 to-white py-[100px] padding-x">
        ...
        <div className="text-center max-w-4xl mx-auto mb-16">
          ...
          >
            Our <span className="text-[#079ADF]">Health Care Specialists</span>
          </h1>
            ...
            {tabOptions.map((tab) => (
              <button
                ...
                className={`px-6 py-3 rounded-xl font-medium transition-all duration-300 ${
                  activeTab === tab.key
                    ? "bg-white text-[#079ADF] shadow-md"
                    : "text-gray-600 hover:text-[#079ADF] hover:bg-blue-50"
                }`}
