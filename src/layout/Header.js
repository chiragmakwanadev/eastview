...
const Header = () => {
  ...
  return (
    <header
      className={`fixed w-full z-50 transition-all duration-500 bg-white/90`}
    >
      <div className="flex justify-between items-center px-36 py-4">
        {/* Logo */}
        <Link href="/" className="flex items-center gap-2">
          <img src="/images/east-logo.png" alt="Logo" className="w-12 h-12" />
        ...
        <div className="hidden md:flex gap-4">
          ...
          <Link
            ...
            className="px-5 py-2 border border-green-600 text-green-700 rounded-full shadow hover:bg-green-50 transition"
          >
            Pharmacy
          </Link>
        </div>
