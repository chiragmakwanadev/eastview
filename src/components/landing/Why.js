...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Our on-site pharmacy allows you to fill prescriptions quickly and easily. Get immediate access to medications and professional guidance from expert pharmacists.",
  },
  {
    question: "Commitment to Your Family’s Health",
    answer:
      "From newborns to seniors, we provide comprehensive family medicine services, including pediatrics, women’s health, and geriatric care.",
  },
  {
    question: "Convenient & Accessible Location",
    answer:
      "Our clinic is centrally located with ample parking, wheelchair access, flexible appointments, and easy public transport options.",
  },
  {
