...
const Banner = ({ subtitle, backgroundImage = "/images/banner-bg.jpeg", buttonText }) => {
  ...
  return (
    <div className="relative w-full" style={{ height: Clamp(22, 35) }}>
      <div className="flex flex-col items-center justify-center text-center text-black px-4 border-none h-full">
        <h1 className="text-[16px] xl:text-[18px] font-normal mb-2 bg-white px-5 py-2 rounded-full">Your health connected with care!</h1>
